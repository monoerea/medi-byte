import { type } from 'os';
import { validatePhone, validateEmail, validat, validatePhoneeName, ValidateID } from './utils';
...
export const initData = {
  ...
  InsuranceSSN: ['23465423'],
  InsuranceTelephone: ['34454567'],
    ...
    export const steps = [
      {
        ...
        fields:[
          ...
          { id: 'CellPhone', name: 'Cell Phone', group: 5, type: 'input', validate: validatePhone, placeholder: 'Enter Cell Phone' },
          ...
          { id: 'SSN', name: 'SSN', group: 8, type: 'input', placeholder: 'Enter SSN', validate: validatePhone },
          { id: 'HomePhone', name: 'Home Phone', group: 9, type: 'input', validate: validatePhone, placeholder: 'Enter Home Phone' },
          { id: 'WorkPhone', name: 'Work Phone', group: 9, type: 'input', validate: validatePhone, placeholder: 'Enter Work Phone' },
          ...
          { id: 'EmployerPhone', name: 'Employer Phone', group: 13, type: 'input', placeholder: 'Enter Employer Phone', validate: validatePhone },
          ...
          { id: 'EmergencyCellphone', name: 'Emergency Cellphone', group: 15, type: 'input', placeholder: 'Enter Emergency Cellphone', validate: validatePhone },
          { id: 'EmergencyWorkphone', name: 'Emergency Workphone', group: 15, type: 'input', placeholder: 'Enter Emergency Workphone', validate: validatePhone },
      ...
      },
      {
        ...
        fields: [
          ...
          { id: 'SubscriberNo', name: 'Subscriber No', group: 2 , type:'input', placeholder: 'Enter Subscriber Number', validate: ValidateID},
          { id: 'GroupNo', name: 'Group No', group: 2, type:'input', placeholder: 'Enter Group Number', validate: ValidateID },
          ...
          { id: 'InsuranceSSN', name: 'Insurance SSN', group: 6, type:'input', placeholder: 'Enter Insurance SSN',  validate: validatePhone},
          { id: 'InsuranceTelephone', name: 'Insurance Telephone', group: 6, type:'input', placeholder: 'Enter Insurance Telephone', validate: validatePhone},
